            ...
            >
              <div className="plasmo-flex plasmo-items-center plasmo-justify-between">
                ...
                <button
                  ...
                  className="plasmo-text-xs plasmo-text-blue-600 hover:plasmo-text-blue-800 plasmo-flex plasmo-items-center plasmo-gap-1"
                  title="Manage Variables"
                >
                  <svg className="plasmo-h-3.5 plasmo-w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
