...
const TemplateItem = memo(({
  ...
  return (
    ...
    >
      <div className="plasmo-py-1 plasmo-px-2">
        {/* Template Header with Actions */}
        <div className="plasmo-flex plasmo-items-center plasmo-justify-between">
          <div className="plasmo-flex plasmo-items-center plasmo-gap-1 plasmo-flex-1 plasmo-min-w-0">
            {isFavorite && (
              <span className="plasmo-text-accent-500 plasmo-flex-shrink-0">
                <svg className="plasmo-w-3.5 plasmo-h-3.5" viewBox="0 0 20 20" fill="currentColor">
          ...
          {/* Action Buttons */}
          <div className="plasmo-flex plasmo-items-center plasmo-ml-1 plasmo-flex-shrink-0">
            <button
              onClick={handleCopyClick}
              className="plasmo-action-btn-compact"
              aria-label="Copy template"
              disabled={isCopying}
            >
              {isCopying ? (
                <svg className="plasmo-w-3.5 plasmo-h-3.5 plasmo-animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                <svg className="plasmo-w-3.5 plasmo-h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className={`plasmo-action-btn-compact ${isFavorite ? 'plasmo-text-accent-500' : 'plasmo-text-gray-400'}`}
              aria-label={isFavorite ? "Remove from favorites" : "Add to favorites"}
            >
              <svg className="plasmo-w-3.5 plasmo-h-3.5" viewBox="0 0 20 20">
                {isFavorite ? (
            ...
            <button
              ...
              className="plasmo-action-btn-compact plasmo-text-error-500 hover:plasmo-text-error-700"
        ...
        <div className="plasmo-template-description-compact">
          {contentPreview}
        </div>
      </div>
    </div>
